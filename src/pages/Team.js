  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #F5BF83, #F2A8A5, #F08DB9)",
        }}
      >
        ...
        <span
          ...
          style={{
            boxShadow: "0 0 0 6px rgba(242,168,165,0.18)",
          }}
        />
      </div>
    ...
    <div className="mb-16 last:mb-0">
      <div className="flex items-center gap-4 mb-8">
        <span
          ...
          style={{ background: "linear-gradient(90deg, transparent, #F2A8A5)" }}
        />
        ...
        <span
          ...
          style={{ background: "linear-gradient(90deg, #F2A8A5, transparent)" }}
        />
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1000px] mx-auto px-6 md:px-8">
        ...
        {error && (
          <p className="text-center text-lava/50 text-sm">{error}</p>
        )}
        ...
        {!teams && !error && (
          <div className="flex justify-center gap-6 flex-wrap">
            {Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="w-[92px] h-[92px] rounded-2xl bg-lava/5 animate-pulse"
              />
            ))}
          </div>
        )}
        ...
        {teams && totalMembers === 0 && !error && (
          <p className="text-center text-lava/50 text-sm">
